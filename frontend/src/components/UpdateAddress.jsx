...
const UpdateAddress = () => {
  ...
  const { data: getAddressById, isLoading } = useQuery({
  ...
  const { mutate: updateAddressMutate, isPending } = useMutation({
  ...
  if (isLoading) return <h1 className="text-4xl text-white">Loading...</h1>;
  return (
    <div className="w-full h-screen flex flex-col pt-10 items-center">
      <div className="flex flex-col ">
        ...
        <h3 className="text-[30px] text-white mb-4">Update Address</h3>
        <form
